...
import 'package:cat_ship/l10n/app_localizations.dart';
...
class SettingDialog {
  static Future<Settings?> showDialogText(BuildContext context, Settings me) async {
    //globalData.logger.i('showDialogText() ${me.toJson().toString()}\n');
    ...
    return showDialog<Settings>(
        ...
        builder: (BuildContext context) {
          return StatefulBuilder(builder: (context, setState) {
            return SimpleDialog(title: Text(AppLocalizations.of(context)!.enterName), children: <Widget>[
              Padding(
